      ...
      <Box color="white" maxWidth="1280px" margin="0 auto">
        ...
        >
          <nav>
            ...
            {/* <a href={socials[0].url} className="navBarLink">
              <FontAwesomeIcon icon={socials[0].icon} size="2x" />
            </a>
            <a href={socials[1].url} className="navBarLink">
              <FontAwesomeIcon icon={socials[1].icon} size="2x" />
            </a>
            <a href={socials[2].url} className="navBarLink">
              <FontAwesomeIcon icon={socials[2].icon} size="2x" />
            </a>
            <a href={socials[3].url} className="navBarLink">
              <FontAwesomeIcon icon={socials[3].icon} size="2x" />
            </a>
            <a href={socials[4].url} className="navBarLink">
